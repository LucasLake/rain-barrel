...
|---|---|---|
| `ann_interior.jpg` | Electronics enclosure, interior | 1, 2, 3, 4, 5, 6 |
| `ann_side_right.jpg` | Enclosure, right side | 7, 8, 9 |
| `ann_side_left.jpg` | Enclosure, left side | 20, 21, 22 |
| `ann_bottom.jpg` | Enclosure, bottom ventilation | 19 |
| `ann_plumbing.jpg` | Plumbing on the wall | 10, 11, 12, 13, 14, 15 |
| `ann_pump.jpg` | Pump | 17 |
| `ann_float.jpg` | Float switch | 18 |

## `raw/`

The same photos without the numbered callouts, resized to a max of
1920px on the long side. Kept for reference (e.g. if you want to
re-annotate them yourself, or just see the unedited shots).

| File | Corresponds to |
|---|---|
| `raw/raw_interior.jpg` | `ann_interior.jpg` |
| `raw/raw_side_right.jpg` | `ann_side_right.jpg` |
| `raw/raw_side_left.jpg` | `ann_side_left.jpg` |
| `raw/raw_bottom.jpg` | `ann_bottom.jpg` |
| `raw/raw_plumbing.jpg` | `ann_plumbing.jpg` |
